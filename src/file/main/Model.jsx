...
const Model = ({model,setCarts,carts }) => {
  ...
  const[isBuy , SetIsBuy] = useState(false);
    ...
    return (
        ...
        <div className='flex justify-center items-center h-56 bg-zinc-200 group'>
            <img className='h-40 w-40 object-contain transition-transform group-hover:scale-110 duration-500'  src={model.icon} alt="img" />
        </div>
<      div
